...
#pragma warning restore CA2000 // Dispose objects before losing scope
		...
		ConcurrentDictionary<IWallet, TrackedAutoStart> trackedAutoStarts, CancellationToken cancellationToken)
	{
		...
		catch (UnexpectedRoundPhaseException e)
		{
			...
			wallet.LogInfo(CoordinatorName, $"{nameof(CoinJoinClient)} failed2 with exception:  '{e}\n {e.StackTrace}'");
		}
		...
		{
			wallet.LogError(CoordinatorName, $"{nameof(CoinJoinClient)} failed1 with exception: '{e}\n {e.StackTrace}'");
		}
